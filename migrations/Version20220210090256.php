 ...
 */
final class Version20220210090256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario CHANGE password password VARCHAR(255) NOT NULL, CHANGE dni dni VARCHAR(9) DEFAULT NULL, CHANGE fechanac fechanac DATE NOT NULL');
    }
