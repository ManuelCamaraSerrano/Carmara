 ...
 */
final class Version20220208112232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario ADD telefono INT NOT NULL, DROP tipocarnet');
    }
