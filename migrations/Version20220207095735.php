 ...
 */
final class Version20220207095735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario CHANGE foto foto VARCHAR(150) NOT NULL');
    }
