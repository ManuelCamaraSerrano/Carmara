 ...
 */
final class Version20220217084607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario CHANGE password password VARCHAR(600) DEFAULT NULL');
    }
