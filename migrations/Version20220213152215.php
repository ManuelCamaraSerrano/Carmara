 ...
 */
final class Version20220213152215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario CHANGE password password VARCHAR(600) NOT NULL');
    }
