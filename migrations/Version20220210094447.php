 ...
 */
final class Version20220210094447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario DROP fechanac, CHANGE password password VARCHAR(255) NOT NULL, CHANGE dni dni VARCHAR(9) DEFAULT NULL');
    }
